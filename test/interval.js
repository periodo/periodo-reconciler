...
test('valid intervals have lengths', t => {
  t.plan(3)
  t.equal(Interval.Interval(2, 2).length(), 0)
  t.equal(Interval.Interval(2, 4).length(), 2)
  t.equal(Interval.Interval(4, 3).length(), 1)
})
...
test('proper intervals may overlap', t => {
  ...
  t.plan(9)
  t.equal(i6to10.overlaps(i6to10), 4)
  t.equal(i6to10.overlaps(i4to8), 2)
  t.equal(i4to8.overlaps(i6to10), 2)
  t.equal(i6to10.overlaps(i3to7), 1)
  t.equal(i3to7.overlaps(i6to10), 1)
  t.equal(i6to10.overlaps(i2to6), 0)
  t.equal(i2to6.overlaps(i6to10), 0)
...
test('improper intervals may overlap', t => {
  const i10to6 = Interval.Interval(10, 6)
      ...
      , i1to5 = Interval.Interval(1, 5)
  t.plan(9)
  t.equal(i10to6.overlaps(i10to6), 4)
  t.equal(i10to6.overlaps(i4to8), 2)
  t.equal(i4to8.overlaps(i10to6), 2)
  t.equal(i10to6.overlaps(i3to7), 1)
  t.equal(i3to7.overlaps(i10to6), 1)
  t.equal(i10to6.overlaps(i6to2), 0)
  t.equal(i6to2.overlaps(i10to6), 0)
